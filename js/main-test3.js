...
$.ajax(settings).done(function (data) {
  ...
  $.each(data.photos.photo, function (i, gp) {
    ...
    //$("#flickr").append('<a href="' + url_z + '"target="popup" onclick="window.open("url_z","popup","width=600,height=600,scrollbars=no,resizable=no"); return false;"><img src="' + url_m + '"></a>');
  });

});

jQuery("#flickr").unitegallery({
  tiles_type:"nested"
});

/*
    <a href="#"
      onClick="MyWindow=window.open('http://www.google.com','MyWindow','width=600,height=300'); return false;">Click
      Here</a>

    <br>

    <a href="http://kanishkkunal.com" target="popup"
...
window.open('https://javascript.info/')
    ...
    <!--
      <body style="margin: 0px; background: #0e0e0e; height: 100%"><img style="display: block;-webkit-user-select: none;margin: auto;background-color: hsl(0, 0%, 90%);transition: background-color 300ms;" src="https://farm1.staticflickr.com/112/293156319_1534f58d6d.jpg"></body>
    -->
